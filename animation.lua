...
local Converted = {
	...
	["_ImageLabel"] = Instance.new("TextLabel");
...
Converted["_ImageLabel"].RichText = true
Converted["_ImageLabel"].Font = Enum.Font.Arial
...
-- ════════════════════════════════════════════════════════════
--  MENU DRAG  (drag _Menu by holding _CloseArea)
-- ════════════════════════════════════════════════════════════
...
coroutine.wrap(function()
	task.wait()  -- let everything initialize first
	makeDraggable(Converted["_Menu"], Converted["_CloseArea"])
end)()
